...
const AboutMe = () => {
  return (
    <div className="w-full text-white text-lg sm:text-xl lg:text-2xl font-['DM Sans'] space-y-3 sm:py-16 sm:space-y-4 lg:space-y-6 px-4 sm:px-6 lg:px-0">
      <p>hey there! 👋</p>
      <p>
        i’m a software engineer 🖥️, ui/ux enthusiast 🎨, and consultant 🤝 based in
        toronto, canada. 🇨🇦 i’m currently pursuing a dual degree in software
        engineering and business at western university & ivey business school. 🎓
      </p>
      <p>
